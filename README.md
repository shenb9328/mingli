...
项目的机器可读命理知识库位于 `data/` 目录，当前重点是传统子平命理的**原典、结构化规则、格局逻辑、干支关系、合化状态与岁运规则**。

详细的数据用途、文件职责、证据等级、程序化流程及本轮扩充说明，请阅读：

- [命理知识数据库说明](data/README.md)

数据库遵循一个重要原则：**古籍原文、传统解释和程序工程规则分层保存**。工程中的权重、状态机和判断流程不会冒充古籍原文；无法可靠核验来源的口诀也不会因为“常见”就自动升级为高置信经典规则。
